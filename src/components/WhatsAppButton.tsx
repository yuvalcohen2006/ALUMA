...
const WhatsAppButton = () => {
  return (
    <a
      ...
      className="hidden md:flex lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white items-center justify-center shadow-luxury hover:scale-110 transition-smooth"
    >
      <WhatsAppIcon />
    </a>
  );
