  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="hidden md:flex fixed bottom-24 md:bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-primary text-primary-foreground items-center justify-center shadow-luxury hover:scale-110 transition-smooth focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
      >
