...
const ArticleSkeleton = () => (
  <div className="container-luxury max-w-3xl">
    ...
    <div className="animate-pulse motion-reduce:animate-none" aria-hidden="true">
      <div className="h-5 w-32 rounded-[10px] bg-secondary" />
      <div className="h-10 w-4/5 rounded-[10px] bg-secondary mx-auto mt-12" />
      <div className="h-10 w-3/5 rounded-[10px] bg-secondary mx-auto mt-4" />
      <div className="aspect-[16/9] rounded-[14px] bg-secondary mt-10" />
      <div className="h-5 w-full rounded-[10px] bg-secondary mt-10" />
      <div className="h-5 w-11/12 rounded-[10px] bg-secondary mt-4" />
      <div className="h-5 w-4/5 rounded-[10px] bg-secondary mt-4" />
    </div>
  </div>
);
    ...
    <Layout>
      ...
      <article className="pt-32 md:pt-40 pb-20">
        <div className="container-luxury max-w-3xl">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl text-primary mt-3 mb-5 leading-tight text-center">
            {post.title}
          </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-[18px] text-muted-foreground mt-5">
              {meta.map((part, i) => (
                <Fragment key={part}>
                  ...
                  {i > 0 && <span className="w-px h-4 shrink-0 bg-primary/45" aria-hidden="true" />}
                  <span>{part}</span>
                </Fragment>
              ))}
            </div>
          ...
          {post.cover_image_url && (
            <div className="aspect-[16/9] overflow-hidden rounded-[14px] border border-border shadow-soft mt-10 mb-10 bg-secondary">
