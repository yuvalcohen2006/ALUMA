    ...
    <Layout>
      ...
      <section className="bg-background pt-24 md:pt-28 pb-6 md:pb-10">
        <div className="container-luxury">
          <Link
            to="/projects"
            className="group inline-flex items-center gap-2 text-meta text-muted-foreground hover:text-primary transition-smooth"
          >
            <ArrowRight
        ...
        <div className="container-luxury grid md:grid-cols-5 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-2 order-2 md:order-1">
            <div className="mb-8 md:mb-10">
              ...
              <p className="text-lede leading-relaxed text-foreground-soft text-pretty mb-6">
                {project.intro}
              </p>
            ...
            <div className="border border-border rounded-[14px] p-6 md:p-8 mb-6 md:mb-8">
              <h2 className="font-display font-bold text-subsection leading-snug text-primary">
                על הפרויקט
              </h2>
            ...
            <div className="border border-border rounded-[14px] p-6 md:p-8">
              ...
              <ul className="mt-6 space-y-4 mb-8">
                {project.scope.map((s) => (
                  <li key={s} className="flex gap-3 text-meta leading-relaxed text-foreground">
              ...
              <div className="pt-6 border-t border-border">
                ...
                <div className="mt-4 space-y-2 text-meta leading-relaxed text-foreground">
      ...
      {/* BEFORE / AFTER — was a standalone route with invented pairs. It lives
          here now, tied to the project it belongs to, and only appears when we
          hold a real photograph of this space before the work. */}
      {project.beforeAfter && (
        <section className="pb-16 md:pb-24 bg-background">
          <div className="container-luxury">
            <div className="max-w-4xl">
              ...
              <div className="w-20 h-[2px] bg-primary/55 mt-5" aria-hidden="true" />
              <p className="mt-6 text-foreground text-body">
      ...
      <section className="py-20 md:py-24 gradient-cream">
        <div className="container-luxury">
          <div className="flex flex-col items-center text-center">
            <p className="text-meta text-muted-foreground mb-4">מגשימים חלום</p>
            <SectionHeading
              tone="charcoal"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {others.map((p) => (
              <Link key={p.slug} to={`/projects/${p.slug}`} className="group block">
                ...
                <h3 className="font-display font-normal text-card-title text-foreground group-hover:text-accent transition-smooth flex items-center gap-2">
                  {p.name}
                  <ArrowLeft
