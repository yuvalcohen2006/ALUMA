        ...
        <div className="max-w-xl w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebd5a] text-white px-6 py-3 rounded-sm text-sm tracking-wide transition-smooth"
            >
            ...
            <a
              href="tel:0504519062"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-sm text-sm tracking-wide transition-smooth"
            >
